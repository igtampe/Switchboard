...
namespace Igtampe.Switchboard.Server {
    ...
    public class Launcher {public static void Launch(String MainFormTitle, SwitchboardConfiguration Config) {Application.Run(new MainForm(MainFormTitle,Config));}}
}
